                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add portfolio</div>
                            </div>
                    ...
                    <a class="btn btn-info" href="<?php echo site_url('dash/view_port'); ?>">Viewl All </a>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-topline-aqua" id="form_wizard_1">
                                ...
                                <form class="form-horizontal" action="<?php echo site_url('dash/add_portfolio'); ?>" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab1">
                                                        <h3 class="block"><font color="red" size="10px">*</font></h3>
                                                  
			                                            
			                                            <div class="form-group">
			                                                <label class="control-label col-md-3">Add document
			                                                    <span class="required"> * </span>
			                                                </label>
			                                                <div class="col-md-5">
			                                               <input type="file"  required name="img" required class="form-control" >
														   </div>
			                                            </div>
														
									   <div class="form-group">
			                                                <label class="control-label col-md-3">Add Icons
			                                                    <span class="required"> * </span>
			                                                </label>
			                                                <div class="col-md-5">
			                                               <input type="file"  required name="img2" required class="form-control" >
														   </div>
			                                            </div>
													    ...
													    <div class="form-group">
			                                                ...
			                                                <div class="col-md-5">
			                                                   <center><button name="submit" class="btn btn-info">Submit</button></center>
			                                                </div>
			                                            </div>
														</form>
                                ...
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        <div class="post out">
                                            ...
                                            <div class="message">
                                                <span class="arrow"></span> <a href="javascript:;" class="name">CWT SPORTS</a> <span class="datetime">9:10</span>
