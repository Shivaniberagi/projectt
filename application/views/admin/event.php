                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"> Event Gallery </div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index-2.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>   
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                            <a href="<?php echo site_url('dash/gallery'); ?>">    <button class="btn btn-info">
					                                    ...
					                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
															...
															$produuct_query=mysqli_query($con,"select * from `crane_gallery`");
															//var_dump($produuct_query);
															  $i=1;
															while($product_fetch=mysqli_fetch_array($produuct_query))
															{
																//var_dump($produuct_query);
															?>
																<tr class="odd gradeX">
																<td> <?php echo $i++; ?></td>
			<td class="patient-img center <img src="<?php echo base_url(); ?>/gallery/<?php  echo $product_fetch['gallery_image']; ?>" alt="images">
																	</td>
																	
																	<td><a href="#"><?php  echo $product_fetch['gallery_parents']; ?></a></td>
																	
			<td>
<a href="<?php echo base_url(); ?>index.php/dash/delete_gallery/<?php echo $product_fetch['gallery_id']; ?>"
