					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                            <a href="<?php echo site_url('dash/view_port'); ?>">    <button class="btn btn-info">
					                                                    View All <i class="fa fa-plus"></i>
					                                                </button></a>
					                                            </div>
					                                        </div>
					                                     </div>
					                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
															...
															$produuct_query=mysqli_query($con,"select * from `portfolio`");
															...
															?>
																...
																<td> <?php echo $i++; ?>
																	...
																	<td><a href="#"><?php  echo $product_fetch['doc']; ?></a></td>
							<td>
<a href="<?php echo base_url(); ?>index.php/dash/delete_port/<?php echo $product_fetch['id']; ?>"<i class="fa fa-trash-o "></i>
																		</button>
