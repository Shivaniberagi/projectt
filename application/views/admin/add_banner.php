...
include('side_menu.php');
 ...
 @$images=$_FILES['img']['name'];
     if(isset($submit))
     {
       mkdir('../cwt_shop');
       $cwt_sql="insert into
         cwt_banner(cwt_banner,cwt_pos)
        values('$images','$position')";
       ...
       {
		   //mkdir('gallery');
		   move_uploaded_file($_FILES['img']['tmp_name'],"../cwt-shop/cwt-shop/images/demo/".$_FILES['img']['name']);
    echo "<script>alert('Question save to Database successfully');</script>";
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab1">
			                                            ...
			                                            <div class="form-group">
			                                                <label class="control-label col-md-3">Add Image
			                                                    <span class="required"> * </span>
			                                                </label>
			                                                <div class="col-md-5">
			                                               <input type="file" name="img" required class="form-control-textarea" >
														   </div>
			                                            </div>
			                                        <div class="form-group">
			                                                ...
			                                                <div class="col-md-5">
			                                                    <input type="number" name="position"   required class="form-control-textarea" placeholder="position 
													" rows="5" ></textarea>
			                                                </div>
			                                            </div>
